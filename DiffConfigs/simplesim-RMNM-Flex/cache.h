...
//rv
#define MNM_TABLE_SIZE 512
#define MNM_INDEX_BITS 6
//#define MNM_COUNTER_MAX 8
#define MNM_LATENCY 1
#define PLACE 0
#define REPL 1
#define INCR 1
#define DECR 0
...
counter_t Smaller_Cache_Access_Cnt;
counter_t Larger_Cache_Access_Cnt;
...
struct cache_t
{
  ...
  //rv
  int isMNM;
  md_addr_t mnm_table[MNM_TABLE_SIZE];
  int Mnm_Counter_Max;
  ...
  enum cache_tournaments Current_Cache_Config;
  ...
  counter_t mnm_misses;		/* rv: total number of mnm misses */
  counter_t true_mnm_misses; //true mnm misses
  ...
  counter_t reconfigurations; /* -AJS total number of reconfigruations*/
...
cache_create(char *name,		/* name of the cache */
      ...
      unsigned int tournament_length,
      unsigned int accesses_bw_tournaments,
      unsigned int hits_for_win);/* latency in cycles for a hit */
